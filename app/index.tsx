              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
                  <div className="text-center p-4 rounded-lg bg-muted/50">
                    <Calendar size={32} color="#3B82F6" style={{ marginLeft: 'auto', marginRight: 'auto', marginBottom: 8 }} />
                  ...
                  <div className="text-center p-4 rounded-lg bg-muted/50">
                    <Users size={32} color="#3B82F6" style={{ marginLeft: 'auto', marginRight: 'auto', marginBottom: 8 }} />
                  ...
                  <div className="text-center p-4 rounded-lg bg-muted/50">
                    <Building2 size={32} color="#3B82F6" style={{ marginLeft: 'auto', marginRight: 'auto', marginBottom: 8 }} />
